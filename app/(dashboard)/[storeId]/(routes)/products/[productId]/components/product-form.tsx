...
import ImageUpload from '@/components/organisms/loader/image-upload';
...
export const ProductForm: React.FC<ProductFormProps> = ({ 
    ...
    const form = useForm<ProductFormValues>({
        ...
        defaultValues: initialData ? {
            ...
            images: initialData.images.map(image => ({ url: image.id }))
        } : {
            name: ' ',
            images: [],
            price: 0,
                                ...
                                render={({ field }) => (
                                    <FormItem className='flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4'>
                                        ...
                                        <div className='space-y-1 leading-none'>
                                            ...
                                            <FormDescription>This product will apper on home page</FormDescription>
                                        </div>
                                    </FormItem>
                                )}
                            />
                                ...
                                render={({ field }) => (
                                    <FormItem className='flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4'>
                                        ...
                                        <div className='space-y-1 leading-none'>
                                            ...
                                            <FormDescription>This product will not apper on home page</FormDescription>
                                        </div>
                                    </FormItem>
                                )}
                            />
